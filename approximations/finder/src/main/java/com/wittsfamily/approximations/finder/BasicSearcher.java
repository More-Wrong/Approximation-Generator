...
public class BasicSearcher {
	...
	public List<Expression> findCandidateExpressions(double d, int layers, boolean isStart)
	...
	private List<Expression> findAlternatives(Expression found, double trueTarget, boolean negate, boolean invert,
	...
	private List<Expression> tryReplacement(Expression found, double trueTarget, boolean negate, boolean invert,
			int layers) throws IOException, ParseException {
		List<Expression> candidates = new ArrayList<>();
