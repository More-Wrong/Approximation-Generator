...
public class CleaningLog implements CleaningExpression {
    ...
    public boolean cleanFour() {
        ...
        if ((child.getType() == CleaningExpressionType.INTEGER || child.getType() == CleaningExpressionType.REAL)
                && (base.getType() != CleaningExpressionType.INTEGER && base.getType() != CleaningExpressionType.REAL)) {
            ...
            didSomething = true;
                ...
                && (child.getType() != CleaningExpressionType.INTEGER && child.getType() != CleaningExpressionType.REAL)) && parent.getType() == CleaningExpressionType.INVERT) {
